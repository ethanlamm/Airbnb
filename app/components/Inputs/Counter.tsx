	...
	return (
		<div className="flex flex-row items-center justify-between">
			...
			<div className="flex flex-row items-center gap-4">
				<div
					onClick={onReduce}
					className={`flex items-center justify-center w-10 h-10 rounded-full border-[1px] border-neutral-400 text-neutral-600 transition 
                    ${value == 1 ? "cursor-not-allowed hover:opacity-70" : "cursor-pointer hover:opacity-80"}`}
				>
					<AiOutlineMinus />
				</div>
